...
def get_args():
	parser = argparse.ArgumentParser(description="This example script will show you how to use the face detector module.",
									 formatter_class=argparse.ArgumentDefaultsHelpFormatter)
	parser.add_argument("--input", "-i", type=str, required=True,
						help="Path to image file")
	parser.add_argument("--method", "-m", type=str, default='dlib_hog',
						help="Please choose between : opencv_haar , dlib_hog , dlib_cnn , mtcnn , mobilenet_ssd ")
...
def main():
	...
	method_list=['opencv_haar' , 'dlib_hog' , 'dlib_cnn' , 'mtcnn' , 'mobilenet_ssd']
	method=args.method
	...
	if method not in method_list:
		...
		for face in detected_face:
			...
			cv2.rectangle(image_data,(face[0],face[1]),(face[2],face[3]),(255,0,0),2)
